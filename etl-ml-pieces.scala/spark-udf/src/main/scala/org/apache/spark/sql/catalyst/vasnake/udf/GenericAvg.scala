...
import org.apache.spark.sql.catalyst.vasnake.udf.accum.{AccumulatorValue, NumericAccumulatorWithCount => AccImpl}

@ExpressionDescription(usage ="""_FUNC_(expr) - Returns the avg calculated from values of a group.""")
