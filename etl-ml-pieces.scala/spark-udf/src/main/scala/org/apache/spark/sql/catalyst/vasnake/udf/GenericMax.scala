...
@ExpressionDescription(usage ="""_FUNC_(expr) - Returns the max calculated from values of a group.""")
case class GenericMax(
                       child: Expression,
                     ...
                     ) extends GenericAggregate
{
  ...
  override def prettyName: String = "generic_max"
