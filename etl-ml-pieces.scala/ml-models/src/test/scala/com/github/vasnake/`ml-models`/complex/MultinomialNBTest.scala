...
class MultinomialNBTest extends AnyFlatSpec with should.Matchers {
  ...
  it should "produce reference predictions" in {
    val config = MultinomialNBConfig(
      ...
      featureLogProb = Seq(
        Array(-3.2188758248682006,-3.2188758248682006,-3.2188758248682006,-0.8209805520698301,-0.8209805520698301),
        Array(-1.700409690639827,-1.3109449238781037,-1.3109449238781037,-1.700409690639827,-2.3470368555648795)
