...
trait SamplingModelParams extends Params {
  ...
  final val sampleSize: IntParam = new IntParam(this, "sampleSize", "Fit: max number of sample rows for each group", isValid = ParamValidators.gt(0))
  ...
  final val sampleRandomSeed: DoubleParam = new DoubleParam(this, "sampleRandomSeed", "seed value for sampling random function")
