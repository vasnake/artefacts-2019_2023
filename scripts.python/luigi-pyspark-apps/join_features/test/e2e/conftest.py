...
def mocks_session(monkeysession, hadoop_env):
    ...
    monkeysession.setattr("prj.apps.joiner.features.test.e2e.test_app.HdfsClient", HdfsClient)
    monkeysession.setattr("prj.apps.joiner.features.test.e2e.test_app.TestJoinerFeatures.hdfs", HdfsClient())

    monkeysession.setattr("prj.apps.joiner.features.test.e2e.test_app.TMP_HDFS_DIR", os.path.join(hadoop_env.temp_dir, "TMP_HDFS_DIR"))

    monkeysession.setattr("prj.apps.joiner.features.test.e2e.test_app.HiveDataIO", HiveDataIO)
