...
from prj.apps.export.test.it.service import (
    HdfsClient, HadoopEnvironment, HiveMetastoreClient, CustomUDFLibraryMock
)
...
def mocks_session(monkeysession, hadoop_env):
    ...
    monkeysession.setattr(
        "prj.apps.export.audience.base.ExportAudienceBaseApp.hive_client", HiveMetastoreClient()
    )
