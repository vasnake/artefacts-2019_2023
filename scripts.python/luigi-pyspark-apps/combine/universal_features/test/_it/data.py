...
SOURCE_DATA = [
    ...
    {"uid": "10003", "score": None, "part": "P1", "dt": "2020-05-01", "uid_type": "VKID"},
    {"uid": "10004", "score": float("nan"), "part": "P1", "dt": "2020-05-01", "uid_type": "VKID"},
    ...
    {"uid": "10004", "score_map": {"1": 0.2, "2": None}, "part": "P6", "dt": "2020-05-01", "uid_type": "VKID"},
    {"uid": "10005", "score_map": {"1": 0.2, "2": float("nan")}, "part": "P6", "dt": "2020-05-01", "uid_type": "VKID"},
    {"uid": "10006", "score_map": None, "part": "P6", "dt": "2020-05-01", "uid_type": "VKID"},
    # P7
    {"uid": "10001", "cat_list": ["-1", "91"], "part": "P7", "dt": "2020-05-01", "uid_type": "VKID"},
    {"uid": "10002", "cat_list": ["-92", "2"], "part": "P7", "dt": "2020-05-01", "uid_type": "VKID"},
...
def generate_test_data(tmp_dir=TMP_HDFS_DIR):
    ...
    data_specs = [
        {
            ...
            "expected_data": [
                {"uid": "10001", "score": 0.91, "score_list": None, "score_map": None, "cat_list": None, "feature_name": "1_sf", "dt": TARGET_DT, "uid_type": "VKID"},
                {"uid": "10002", "score": 0.92, "score_list": None, "score_map": None, "cat_list": None, "feature_name": "1_sf", "dt": TARGET_DT, "uid_type": "VKID"},
            ],
        },  # 1 simple float
        {
            "feature_name": "2_map",
            ...
            "expected_data": [
                ...
                {"uid": "10002", "score": None, "score_list": None, "score_map": {"92": 0.2, "93": 0.3}, "cat_list": None, "feature_name": "2_map", "dt": TARGET_DT, "uid_type": "VKID"},
        ...
        },  # 11 int group to map keys, hash
        {
            ...
            "expected_data": [
                ...
                {"uid": "12312", "score": 0.99, "feature_name": "1_sf", "dt": TARGET_DT, "uid_type": "VKID"},
            ],
    ...
    print("\n\nUniversal features _test data generated.\n")
    return data
