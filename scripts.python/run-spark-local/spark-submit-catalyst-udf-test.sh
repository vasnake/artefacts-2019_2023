...
export PROJECT_DIR=/mnt/c/Users/valik/data/catalyst_udf_prj
...
TEST_JARS=$(find ${PROJECT_DIR}/target/scala-2.11 -name '*-transformers-assembly-*.jar')
export TEST_JARS
